...
modified: 2026-09-07T06:04:46.120Z
---
...
_**Maneuvers.**_ You learn three maneuvers of your choice from the [Maneuver Options](BattleMaster.md#Maneuvers) section later in this subclass’s description. Many maneuvers enhance an attack in some way. You can use only one maneuver per attack.
...
_**Superiority Dice.**_ You have four Superiority Dice, which are D8 s. A Superiority Die is expended when you use it. You regain all expended Superiority Dice when you finish a Short or Long Rest.
...
Once you use this feature, you can’t do so again until you finish a Long Rest. You can also restore a use of the feature by expending one Superiority Die (no action required). ^BattleMasterLv7

## Level 10

### Improved Combat Superiority

Your Superiority Die becomes a D10. ^BattleMasterLv10

## Level 15

### Relentless

Once per turn, when you use a maneuver, you can roll 1D8 and use the number rolled instead of expending a Superiority Die. ^BattleMasterLv15

## Level 18

### Ultimate Combat Superiority

Your Superiority Die becomes a D12. ^BattleMasterLv18
...
---
const Maneu = context.bound.progression;

// conditional checks to output custom text
if (Maneu < 7) {
    return engine.markdown.create('## Maneuver Options: 3 ^BattleMaster');
} else if (Maneu < 10) {
    return engine.markdown.create('## Maneuver Options: 5 ^BattleMaster');
} else if (Maneu < 15) {
    return engine.markdown.create('## Maneuver Options: 7 ^BattleMaster');
} else {
    return engine.markdown.create('## Maneuver Options: 9 ^BattleMaster');
}
```
